...
class Gui(wx.Frame):
  ...
  def draw_frame_contents(self):
    ...
    self.bck_button = wx.Button(
      self, wx.ID_ANY, 'Back', wx.DefaultPosition, wx.DefaultSize, 0
    )
    self.bck_button.Bind(wx.EVT_BUTTON, self.do_back)
    self.fwd_button = wx.Button(
      self, wx.ID_ANY, 'Fwd', wx.DefaultPosition, wx.DefaultSize, 0
    )
    self.fwd_button.Bind(wx.EVT_BUTTON, self.do_fwd)
    self.fetch_button = wx.Button(
      self, wx.ID_ANY, 'Fetch', wx.DefaultPosition, wx.DefaultSize, 0
    )
    self.fetch_button.Bind(wx.EVT_BUTTON, self.do_fetch)
    self.status_text = wx.TextCtrl(
      self, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.DefaultSize, 0
    )
    self.cfg_button = wx.Button(
      self, wx.ID_ANY, 'Config', wx.DefaultPosition, wx.DefaultSize, 0
    )
