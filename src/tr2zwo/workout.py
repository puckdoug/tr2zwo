  ...
  def create(cls, **kwargs):
    ...
    if 'raw' in kwargs:
      ...
      try:
        ...
        pass
      try:
        instance.description = instance.raw['Workout']['Details'][
          'WorkoutDescription'
        ]
      except Exception:
        pass
      try:
        instance.goaldescription = instance.raw['Workout']['Details'][
          'GoalDescription'
        ]
      except Exception:
        pass
      try:
        instance.subcategory = instance.raw['Workout']['Details'][
          'Progression'
        ]['Text']
      except Exception:
        pass
